...
public abstract partial class LyricTextTagsChangeHandler<TTextTag> : LyricPropertyChangeHandler, ILyricTextTagsChangeHandler<TTextTag> where TTextTag : class, ITextTag, new()
{
