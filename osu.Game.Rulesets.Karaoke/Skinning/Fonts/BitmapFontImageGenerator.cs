...
namespace osu.Game.Rulesets.Karaoke.Skinning.Fonts
{
    public class BitmapFontImageGenerator
    {
        ...
        {
            var width = common.ScaleWidth;
            var height = common.ScaleHeight;

            var paddingTop = originInfo.PaddingUp;
            var paddingLeft = originInfo.PaddingLeft;
            ...
            foreach (var (c, character) in characters)
            {
