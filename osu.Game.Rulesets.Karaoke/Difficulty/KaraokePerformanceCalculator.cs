...
namespace osu.Game.Rulesets.Karaoke.Difficulty
{
    ...
    {
        protected new KaraokeDifficultyAttributes Attributes => (KaraokeDifficultyAttributes)base.Attributes;
        ...
        public KaraokePerformanceCalculator(Ruleset ruleset, DifficultyAttributes attributes, ScoreInfo score)
