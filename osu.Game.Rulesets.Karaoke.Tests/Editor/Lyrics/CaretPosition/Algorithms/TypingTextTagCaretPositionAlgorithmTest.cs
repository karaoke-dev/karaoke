...
namespace osu.Game.Rulesets.Karaoke.Tests.Editor.Lyrics.CaretPosition.Algorithms
{
    ...
    public class TypingTextTagCaretPositionAlgorithmTest : BaseCaretPositionAlgorithmTest<TypingTextTagCaretPositionAlgorithm, TypingTextTagCaretPosition>
    {
        ...
        protected override void AssertEqual(TypingTextTagCaretPosition expected, TypingTextTagCaretPosition actual)
        {
            if (expected == null)
            {
            ...
            else
            {
                ...
                Assert.AreEqual(expected.TypingCaretIndex, actual.TypingCaretIndex);
            }
        }

        private static TypingTextTagCaretPosition createTypingTextTagCaretPosition(IEnumerable<Lyric> lyrics, int lyricIndex, int textTagIndex, int typingCaretIndex)
        {
