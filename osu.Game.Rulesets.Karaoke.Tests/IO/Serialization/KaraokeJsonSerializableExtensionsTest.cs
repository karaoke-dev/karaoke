...
namespace osu.Game.Rulesets.Karaoke.Tests.IO.Serialization
{
    public class KaraokeJsonSerializableExtensionsTest
    {
        ...
        public void TestSerializeNote()
        {
            ...
            const string expeccted = @"{""time_preempt"":600.0,""time_fade_in"":400.0,""start_time_bindable"":0.0,""samples_bindable"":[],""sample_control_point"":{""sample_bank_bindable"":""normal"",""sample_volume_bindable"":100,""sample_bank"":""normal"",""sample_volume"":100},""difficulty_control_point"":{""slider_velocity_bindable"":1.0,""slider_velocity"":1.0},""samples"":[],""auxiliary_samples"":[]}";
